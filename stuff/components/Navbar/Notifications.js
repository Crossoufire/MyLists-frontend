                            ...
                            <div key={data.timestamp}>
                                <Dropdown.Item as="div">
                                    {data.media_type === "serieslist" &&
                                        <Link className="text-light" href={`/details/series/${data.media_id}`}>
                                            <Row className="gx-0">
                                                <Col className="col-2">
                                    ...
                                    {data.media_type === "animelist" &&
                                        <Link className="text-light" href={`/details/anime/${data.media_id}`}>
                                            <Row className="gx-0">
                                                <Col className="col-2">
                                    ...
                                    {data.media_type === "movieslist" &&
                                        <Link className="text-light" href={`/details/movies/${data.media_id}`}>
                                            <Row className="gx-0">
                                                <Col className="col-2">
                                    ...
                                    {data.media_type === "gameslist" &&
                                        <Link className="text-light" href={`/details/games/${data.media_id}`}>
                                            <Row className="gx-0">
                                                <Col className="col-2">
                                    ...
                                    {!data.media_type &&
                                        <Link className="text-light" href={`/profile/${data.payload.username}`}>
                                            <Row className="gx-0">
                                                <Col className="col-2">
