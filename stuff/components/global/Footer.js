...
import {mail} from "@/stuff/utils/constants";
                ...
                <Row className="mb-2 gy-4 text-center text-sm-start">
                    ...
                    <Col xs={12} sm={3} md={3} lg={3} xl={3}>
                        ...
                        <ul className="list-unstyled mb-0">
                            ...
                            <li><Link href="/about" className="text-light" rel="noreferrer" target="_blank">About</Link></li>
                            <li><Link href="/privacy_policy" className="text-light" rel="noreferrer" target="_blank">Privacy Policy</Link></li>
                            <li><Link className="text-light" href="/levels/media_levels">Media levels data</Link></li>
                            <li><Link className="text-light" href="/levels/profile_levels">Profile borders data</Link></li>
                        </ul>
                    </Col>
                </Row>
            </Container>
