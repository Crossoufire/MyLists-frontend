...
import {getUserMetric} from "@/stuff/utils/functions";
			...
			<Col xs={4} sm={3} md={3} lg={2} xl={2}>
				<Card className="bg-transparent border-0">
					<div className="overlay-container">
						...
						/>
						<Link className="overlay" href={`/details/${mediaType}/${mediaData.media_id}`}>
					...
					{isAllOrSearch && <div className="all-status-info">{mediaData.status}</div>}
					<UserMediaInfo
						isCurrent={isCurrent}
						mediaType={mediaType}
						mediaData={mediaData}
